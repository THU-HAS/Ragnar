...
static char REG_IP[] = "166.111.244.72\n";
...
static void m_memc_server_start() {
    int ret = system("memcached -l 0.0.0.0 -p 10086 &");
}

static void m_memc_server_stop() {\
    int ret = system("killall memcached");
}
